"""
Django settings for TodoTecno project.
...
SECRET_KEY = 'django-insecure-yyy0jk-*@(snd%-2ewaewk!9vbtq^ci5#k*brj(*v&-9j^m+sm'
...
WSGI_APPLICATION = 'TodoTecno.wsgi.application'
